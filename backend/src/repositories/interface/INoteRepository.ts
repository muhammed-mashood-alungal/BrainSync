...
export interface INoteRepository {
    ...
    createNote(sessionId : Types.ObjectId , userId : string , pdfFileId : Types.ObjectId , sessionName :string) : Promise<void>
    myNotes(userId: Types.ObjectId, query: string, skip: number, limit: number): Promise<{notes : INoteModel[] ,count : number}>
}