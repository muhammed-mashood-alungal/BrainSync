...
function StudentList({
  ...
  initialStudents: IUserType[];
  totalCount: number;
}) {
  const [students, setStudents] = useState<IUserType[]>(initialStudents);
  const [selectedStudent, setSelectedStudent] = useState<IUserType | null>(
    null
  );
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-gray-800 p-4 rounded-lg">
                ...
                <div
                  className={`text-base font-medium ${
                    selectedStudent.isActive ? "text-green-400" : "text-red-400"
                  }`}
                >
              ...
              <div className="bg-gray-800 p-4 rounded-lg">
                ...
                <p className="text-base font-medium">
                  {formatDate(selectedStudent?.createdAt as string)}
                </p>
              </div>
      ...
      <Confirm
        isOpen={Boolean(blockingStudent)}
        onClose={() => setblockingStudents("")}
